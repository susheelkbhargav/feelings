...
public class MainActivityPager extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.susheel.autism.feelings.R.layout.activity_main_pager);
        ...
        tabLayout = (TabLayout) findViewById(com.susheel.autism.feelings.R.id.sliding_tabs);
    ...
    protected void onStart() {
        ...
        SharedPreferences sharedPref = getSharedPreferences(getString(com.susheel.autism.feelings.R.string.password),
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.susheel.autism.feelings.R.menu.menu_main, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == com.susheel.autism.feelings.R.id.action_setting) {
