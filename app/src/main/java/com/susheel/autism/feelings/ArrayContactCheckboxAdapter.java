    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(
                    com.susheel.autism.feelings.R.layout.item_checkbox, parent, false);
        }

        CheckBox checkBox = (CheckBox) convertView.findViewById(com.susheel.autism.feelings.R.id.checkbox1);
