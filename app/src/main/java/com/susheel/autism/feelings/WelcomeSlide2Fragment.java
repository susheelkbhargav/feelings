...
public class WelcomeSlide2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(com.susheel.autism.feelings.R.layout.fragment_welcome_slide2, container, false);
        ...
        startButton = (Button) v.findViewById(com.susheel.autism.feelings.R.id.start_app_button);

        startButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SharedPreferences sharedPreferences = getActivity().getSharedPreferences(getString(com.susheel.autism.feelings.R.string.password),
